...
template<class Type>
hybridLeastSquares1<Type>::hybridLeastSquares1
(
    const fvMesh& mesh,
    Istream& schemeData
)
...
<
    ...
    >
>
hybridLeastSquares1<Type>::calcGrad
(
...
) const
{
    ...
    const hybridLeastSquares1Vectors& hlsv = hybridLeastSquares1Vectors::New(mesh);
