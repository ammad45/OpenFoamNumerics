...
namespace Foam
{
    defineTypeNameAndDebug(hybridLeastSquaresVectors, 0);
}


// * * * * * * * * * * * * * * * * Constructors * * * * * * * * * * * * * * //

Foam::hybridLeastSquaresVectors::hybridLeastSquaresVectors(const fvMesh& mesh)
:
...
Foam::hybridLeastSquaresVectors::~hybridLeastSquaresVectors()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void Foam::hybridLeastSquaresVectors::calcLeastSquaresVectors()
{
    cpuTime calcTimer;
...
bool Foam::hybridLeastSquaresVectors::movePoints()
{
    calcLeastSquaresVectors();
    return true;
}
