...
template<class Type>
hybridFaceLeastSquares<Type>::hybridFaceLeastSquares
(
    const fvMesh& mesh,
    Istream& schemeData
)
...
<
    ...
    >
>
hybridFaceLeastSquares<Type>::calcGrad
(
...
) const
{
    ...
    const hybridFaceLeastSquaresVectors& hlsv =
        hybridFaceLeastSquaresVectors::New(mesh);
